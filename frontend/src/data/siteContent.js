...
export const images = {
  ...
  nameMeaning:    valsiiImage('VALSII IN VILLAGE DISCUSSION.png'),
  mobileAddiction: valsiiImage('YOUNG MAN DISCUSSION.png'),
  fearManagement: valsiiImage('GUIDING YOUNGSTERS.png'),
};
